...
\input{pretextual/dedicatoria}      % opcional
\input{pretextual/agradecimentos}   % opcional
\input{pretextual/epigrafe}         % opcional
\input{pretextual/resumo}           % obrigatorio
\input{pretextual/abstract}         % obrigatorio
...
\input{pretextual/siglas}           % opcional
...
\input{capitulos/03-procedimentos-metodologicos}
\input{capitulos/04-analise-e-discussao}
...
\input{postextual/apendices}        % opcional
\input{postextual/anexos}           % opcional
